...
--Username Faunction By Mohamamd!
 local function lock_group_username(msg, data, target)
  ...
  if group_username_lock == 'yes' then
    return reply_msg(msg.id,"> #Username is #already locked", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_username'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Username has been #locked", ok_cb, false)
  end
end
...
local function unlock_group_username(msg, data, target)
  ...
  if group_username_lock == 'no' then
    return reply_msg(msg.id,"> #Username is #already unlocked", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_username'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> Username has been #unlocked", ok_cb, false)
  end
end
--Operator Fanction By Mohammad
 local function lock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'yes' then
    return reply_msg(msg.id,"> #Operator is #already locked", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_operator'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Operator has been #locked", ok_cb, false)
  end
end
...
local function unlock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'no' then
    return reply_msg(msg.id,"> #Operator is #already unlocked", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_operator'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> Operator has been #unlocked", ok_cb, false)
  end
end
