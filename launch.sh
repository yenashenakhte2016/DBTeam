...
if [ "$1" = "install" ]; then
  ...
  #Adding some color. By @MohammadDeveloper
   echo -e "\033[38;5;208m"
   echo -e "     > Channel : @MuteTeam                        "
   echo -e "     > Developer : @MohammadDeveloper                       "
   echo -e "     > Bot ID : @GroupSecurityBot                        "
   echo -e "     > Github : No Open Github     "
   echo -e "                                              \033[0;00m"
   echo -e "\e[36m"
